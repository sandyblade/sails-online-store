...
import { PersonCircle, PersonFillAdd, Search, Heart, Cart, Grid, TelephoneOutbound, Envelope, PinMap, PersonPlus, CurrencyDollar, ArrowRightCircle } from 'react-bootstrap-icons';
